...
import com.tonic.plugins.profiler.recording.RecordingTab;
...
public class ProfilerWindow extends JFrame {
    ...
    private com.tonic.plugins.profiler.leak.LeakDetectorTab leakDetectorTab;

    // GC Pause Analysis
    private com.tonic.plugins.profiler.gc.GCPauseAnalyzer gcPauseAnalyzer;
    private com.tonic.plugins.profiler.gc.GCTuningAdvisor gcTuningAdvisor;
    private JTextArea gcStatsArea;
    private JTextArea gcRecommendationsArea;

    // Event Timeline
    private com.tonic.plugins.profiler.timeline.TimelinePanel timelinePanel;
    ...
    private void initializeComponents() {
        ...
        leakDetectorTab = new com.tonic.plugins.profiler.leak.LeakDetectorTab();
        tabbedPane.addTab("Leak Detector", leakDetectorTab);
        timelinePanel = new com.tonic.plugins.profiler.timeline.TimelinePanel(gcPauseAnalyzer);
    ...
    private JPanel createResourceMonitorPanel() {
        ...
        gcPauseAnalyzer = new com.tonic.plugins.profiler.gc.GCPauseAnalyzer(500);
        gcTuningAdvisor = new com.tonic.plugins.profiler.gc.GCTuningAdvisor(gcPauseAnalyzer);
    ...
    private JPanel createStatusBar() {
        ...
        apiToggleBtn.addActionListener(e -> {
            com.tonic.plugins.profiler.server.ProfilerServer server = com.tonic.plugins.profiler.server.ProfilerServer.getInstance();
            if (server.isRunning()) {
                server.stop();
    ...
    private void updateGCAnalysis() {
        ...
        try {
            // Update statistics
            com.tonic.plugins.profiler.gc.GCPauseAnalyzer.GCStatistics stats = gcPauseAnalyzer.getStatistics();
            ...
            java.util.List<com.tonic.plugins.profiler.gc.GCTuningAdvisor.Recommendation> recommendations =
                gcTuningAdvisor.getRecommendations();

            StringBuilder recSb = new StringBuilder();

            for (com.tonic.plugins.profiler.gc.GCTuningAdvisor.Recommendation rec : recommendations) {
